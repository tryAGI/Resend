...
namespace Resend
{
    public partial class ContactsClient
    {
        ...
        partial void PrepareDeleteContactsByContactIdSegmentsBySegmentIdRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string contactId,
            string segmentId);
        partial void ProcessDeleteContactsByContactIdSegmentsBySegmentIdResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessDeleteContactsByContactIdSegmentsBySegmentIdResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Resend.RemoveContactFromSegmentResponseSuccess> DeleteContactsByContactIdSegmentsBySegmentIdAsync(
            string contactId,
            string segmentId,
            global::Resend.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await DeleteContactsByContactIdSegmentsBySegmentIdAsResponseAsync(
                contactId: contactId,
                segmentId: segmentId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Resend.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Resend.AutoSDKHttpResponse<global::Resend.RemoveContactFromSegmentResponseSuccess>> DeleteContactsByContactIdSegmentsBySegmentIdAsResponseAsync(
            string contactId,
            string segmentId,
            global::Resend.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareDeleteContactsByContactIdSegmentsBySegmentIdArguments(
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareDeleteContactsByContactIdSegmentsBySegmentIdRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Resend.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Resend.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "deleteContactsByContactIdSegmentsBySegmentId",
                                methodName: "DeleteContactsByContactIdSegmentsBySegmentIdAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessDeleteContactsByContactIdSegmentsBySegmentIdResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Resend.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessDeleteContactsByContactIdSegmentsBySegmentIdResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
