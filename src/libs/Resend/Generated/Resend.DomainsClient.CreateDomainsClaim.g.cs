...
namespace Resend
{
    public partial class DomainsClient
    {
        ...
        private static readonly global::Resend.EndPointSecurityRequirement s_CreateDomainsClaimSecurityRequirement0 =
        ...
        private static readonly global::Resend.EndPointSecurityRequirement[] s_CreateDomainsClaimSecurityRequirements =
            new global::Resend.EndPointSecurityRequirement[]
            {                s_CreateDomainsClaimSecurityRequirement0,
            };
        partial void PrepareCreateDomainsClaimArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Resend.CreateDomainClaimRequest request);
        partial void PrepareCreateDomainsClaimRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Resend.CreateDomainClaimRequest request);
        partial void ProcessCreateDomainsClaimResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCreateDomainsClaimResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Resend.DomainClaim> CreateDomainsClaimAsync(

            global::Resend.CreateDomainClaimRequest request,
            global::Resend.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await CreateDomainsClaimAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Resend.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Resend.AutoSDKHttpResponse<global::Resend.DomainClaim>> CreateDomainsClaimAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreateDomainsClaimArguments(
            ...
            var __authorizations = global::Resend.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateDomainsClaimSecurityRequirements,
                operationName: "CreateDomainsClaimAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreateDomainsClaimRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Resend.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Resend.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "createDomainsClaim",
                                methodName: "CreateDomainsClaimAsync",
                                pathTemplate: "\"/domains/claim\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateDomainsClaimResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Resend.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreateDomainsClaimResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<global::Resend.DomainClaim> CreateDomainsClaimAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Resend.CreateDomainClaimRequest
            {
                Name = name,
                Region = region,
            ...
            return await CreateDomainsClaimAsync(
                request: __request,
                requestOptions: requestOptions,
