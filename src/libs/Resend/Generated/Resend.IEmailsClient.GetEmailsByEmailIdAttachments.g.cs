...
namespace Resend
{
    public partial interface IEmailsClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Resend.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Resend.AutoSDKHttpResponse<global::Resend.ListAttachmentsResponse>> GetEmailsByEmailIdAttachmentsAsResponseAsync(
            global::System.Guid emailId,
            int? limit = default,
            global::System.Guid? after = default,
            global::System.Guid? before = default,
