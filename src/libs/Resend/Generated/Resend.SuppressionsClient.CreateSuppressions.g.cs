...
namespace Resend
{
    public partial class SuppressionsClient
    {
        ...
        private static readonly global::Resend.EndPointSecurityRequirement s_CreateSuppressionsSecurityRequirement0 =
        ...
        private static readonly global::Resend.EndPointSecurityRequirement[] s_CreateSuppressionsSecurityRequirements =
            new global::Resend.EndPointSecurityRequirement[]
            {                s_CreateSuppressionsSecurityRequirement0,
            };
        partial void PrepareCreateSuppressionsArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Resend.CreateSuppressionOptions request);
        partial void PrepareCreateSuppressionsRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Resend.CreateSuppressionOptions request);
        partial void ProcessCreateSuppressionsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCreateSuppressionsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Resend.CreateSuppressionResponseSuccess> CreateSuppressionsAsync(

            global::Resend.CreateSuppressionOptions request,
            global::Resend.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await CreateSuppressionsAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Resend.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Resend.AutoSDKHttpResponse<global::Resend.CreateSuppressionResponseSuccess>> CreateSuppressionsAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreateSuppressionsArguments(
            ...
            var __authorizations = global::Resend.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateSuppressionsSecurityRequirements,
                operationName: "CreateSuppressionsAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreateSuppressionsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Resend.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Resend.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "CreateSuppressionsAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateSuppressionsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Resend.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreateSuppressionsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Resend.CreateSuppressionResponseSuccess.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Resend.AutoSDKHttpResponse<global::Resend.CreateSuppressionResponseSuccess>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Resend.CreateSuppressionResponseSuccess.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Resend.CreateSuppressionResponseSuccess> CreateSuppressionsAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Resend.CreateSuppressionOptions
            {
                Email = email,
            };

            return await CreateSuppressionsAsync(
                request: __request,
                requestOptions: requestOptions,
