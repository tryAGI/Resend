...
namespace Resend
{
    public partial class TemplatesClient
    {
        ...
        private static readonly global::Resend.EndPointSecurityRequirement s_CreateTemplatesSecurityRequirement0 =
        ...
        private static readonly global::Resend.EndPointSecurityRequirement[] s_CreateTemplatesSecurityRequirements =
            new global::Resend.EndPointSecurityRequirement[]
            {                s_CreateTemplatesSecurityRequirement0,
            };
        partial void PrepareCreateTemplatesArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Resend.CreateTemplateRequest request);
        partial void PrepareCreateTemplatesRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Resend.CreateTemplateRequest request);
        partial void ProcessCreateTemplatesResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCreateTemplatesResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Resend.CreateTemplateResponseSuccess> CreateTemplatesAsync(

            global::Resend.CreateTemplateRequest request,
            global::Resend.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await CreateTemplatesAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Resend.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Resend.AutoSDKHttpResponse<global::Resend.CreateTemplateResponseSuccess>> CreateTemplatesAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreateTemplatesArguments(
            ...
            var __authorizations = global::Resend.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateTemplatesSecurityRequirements,
                operationName: "CreateTemplatesAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Resend.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Resend.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "CreateTemplatesAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateTemplatesResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Resend.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreateTemplatesResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Resend.CreateTemplateResponseSuccess.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Resend.AutoSDKHttpResponse<global::Resend.CreateTemplateResponseSuccess>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Resend.CreateTemplateResponseSuccess.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Resend.CreateTemplateResponseSuccess> CreateTemplatesAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Resend.CreateTemplateRequest
            {
                Name = name,
                Alias = alias,
                From = from,
            ...
            return await CreateTemplatesAsync(
                request: __request,
                requestOptions: requestOptions,
