...
namespace Resend
{
    public partial class DomainsClient
    {
        ...
        private static readonly global::Resend.EndPointSecurityRequirement s_CreateDomainsByDomainIdClaimVerifySecurityRequirement0 =
        ...
        private static readonly global::Resend.EndPointSecurityRequirement[] s_CreateDomainsByDomainIdClaimVerifySecurityRequirements =
            new global::Resend.EndPointSecurityRequirement[]
            {                s_CreateDomainsByDomainIdClaimVerifySecurityRequirement0,
            };
        partial void PrepareCreateDomainsByDomainIdClaimVerifyArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string domainId);
        partial void PrepareCreateDomainsByDomainIdClaimVerifyRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string domainId);
        partial void ProcessCreateDomainsByDomainIdClaimVerifyResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCreateDomainsByDomainIdClaimVerifyResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Resend.DomainClaim> CreateDomainsByDomainIdClaimVerifyAsync(
            string domainId,
            global::Resend.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await CreateDomainsByDomainIdClaimVerifyAsResponseAsync(
                domainId: domainId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Resend.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Resend.AutoSDKHttpResponse<global::Resend.DomainClaim>> CreateDomainsByDomainIdClaimVerifyAsResponseAsync(
            string domainId,
            global::Resend.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareCreateDomainsByDomainIdClaimVerifyArguments(
            ...
            var __authorizations = global::Resend.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateDomainsByDomainIdClaimVerifySecurityRequirements,
                operationName: "CreateDomainsByDomainIdClaimVerifyAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreateDomainsByDomainIdClaimVerifyRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Resend.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Resend.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "createDomainsByDomainIdClaimVerify",
                                methodName: "CreateDomainsByDomainIdClaimVerifyAsync",
                                pathTemplate: "$\"/domains/{domainId}/claim/verify\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateDomainsByDomainIdClaimVerifyResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Resend.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreateDomainsByDomainIdClaimVerifyResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Resend.DomainClaim.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Resend.AutoSDKHttpResponse<global::Resend.DomainClaim>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Resend.DomainClaim.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
