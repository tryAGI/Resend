...
namespace Resend
{
    public partial class WebhooksClient
    {
        ...
        private static readonly global::Resend.EndPointSecurityRequirement s_WebhooksReplayEventSecurityRequirement0 =
        ...
        private static readonly global::Resend.EndPointSecurityRequirement[] s_WebhooksReplayEventSecurityRequirements =
            new global::Resend.EndPointSecurityRequirement[]
            {                s_WebhooksReplayEventSecurityRequirement0,
            };
        partial void PrepareWebhooksReplayEventArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref global::System.Guid webhookId,
            ref string eventId);
        partial void PrepareWebhooksReplayEventRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::System.Guid webhookId,
            string eventId);
        partial void ProcessWebhooksReplayEventResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessWebhooksReplayEventResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Resend.ReplayWebhookEventResponse> WebhooksReplayEventAsync(
            global::System.Guid webhookId,
            string eventId,
            global::Resend.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await WebhooksReplayEventAsResponseAsync(
                webhookId: webhookId,
                eventId: eventId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Resend.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Resend.AutoSDKHttpResponse<global::Resend.ReplayWebhookEventResponse>> WebhooksReplayEventAsResponseAsync(
            global::System.Guid webhookId,
            string eventId,
            global::Resend.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareWebhooksReplayEventArguments(
            ...
            var __authorizations = global::Resend.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_WebhooksReplayEventSecurityRequirements,
                operationName: "WebhooksReplayEventAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareWebhooksReplayEventRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Resend.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Resend.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "WebhooksReplayEvent",
                                methodName: "WebhooksReplayEventAsync",
                                pathTemplate: "$\"/webhooks/{webhookId}/events/{eventId}/replay\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessWebhooksReplayEventResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Resend.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessWebhooksReplayEventResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Resend.ReplayWebhookEventResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Resend.AutoSDKHttpResponse<global::Resend.ReplayWebhookEventResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Resend.ReplayWebhookEventResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
