...
namespace Resend
{
    public partial class AutomationsClient
    {
        ...
        private static readonly global::Resend.EndPointSecurityRequirement s_AutomationsRemoveSecurityRequirement0 =
        ...
        private static readonly global::Resend.EndPointSecurityRequirement[] s_AutomationsRemoveSecurityRequirements =
            new global::Resend.EndPointSecurityRequirement[]
            {                s_AutomationsRemoveSecurityRequirement0,
            };
        partial void PrepareAutomationsRemoveArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref global::System.Guid automationId);
        partial void PrepareAutomationsRemoveRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::System.Guid automationId);
        partial void ProcessAutomationsRemoveResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessAutomationsRemoveResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Resend.DeleteAutomationResponse> AutomationsRemoveAsync(
            global::System.Guid automationId,
            global::Resend.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await AutomationsRemoveAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Resend.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Resend.AutoSDKHttpResponse<global::Resend.DeleteAutomationResponse>> AutomationsRemoveAsResponseAsync(
            global::System.Guid automationId,
            global::Resend.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareAutomationsRemoveArguments(
            ...
            var __authorizations = global::Resend.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_AutomationsRemoveSecurityRequirements,
                operationName: "AutomationsRemoveAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareAutomationsRemoveRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Resend.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Resend.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "AutomationsRemove",
                                methodName: "AutomationsRemoveAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessAutomationsRemoveResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Resend.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessAutomationsRemoveResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
