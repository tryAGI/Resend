...
namespace Resend
{
    public partial class BroadcastsClient
    {
        ...
        private static readonly global::Resend.EndPointSecurityRequirement s_BroadcastsCreateSecurityRequirement0 =
        ...
        private static readonly global::Resend.EndPointSecurityRequirement[] s_BroadcastsCreateSecurityRequirements =
            new global::Resend.EndPointSecurityRequirement[]
            {                s_BroadcastsCreateSecurityRequirement0,
            };
        partial void PrepareBroadcastsCreateArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Resend.CreateBroadcastOptions request);
        partial void PrepareBroadcastsCreateRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Resend.CreateBroadcastOptions request);
        partial void ProcessBroadcastsCreateResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessBroadcastsCreateResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Resend.CreateBroadcastResponseSuccess> BroadcastsCreateAsync(

            global::Resend.CreateBroadcastOptions request,
            global::Resend.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await BroadcastsCreateAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Resend.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Resend.AutoSDKHttpResponse<global::Resend.CreateBroadcastResponseSuccess>> BroadcastsCreateAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareBroadcastsCreateArguments(
            ...
            var __authorizations = global::Resend.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_BroadcastsCreateSecurityRequirements,
                operationName: "BroadcastsCreateAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareBroadcastsCreateRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Resend.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Resend.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "BroadcastsCreate",
                                methodName: "BroadcastsCreateAsync",
                                pathTemplate: "\"/broadcasts\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessBroadcastsCreateResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Resend.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessBroadcastsCreateResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Resend.CreateBroadcastResponseSuccess.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Resend.AutoSDKHttpResponse<global::Resend.CreateBroadcastResponseSuccess>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Resend.CreateBroadcastResponseSuccess.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await BroadcastsCreateAsync(
                request: __request,
                requestOptions: requestOptions,
