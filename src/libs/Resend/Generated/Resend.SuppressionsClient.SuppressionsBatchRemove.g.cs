...
namespace Resend
{
    public partial class SuppressionsClient
    {
        ...
        private static readonly global::Resend.EndPointSecurityRequirement s_SuppressionsBatchRemoveSecurityRequirement0 =
        ...
        private static readonly global::Resend.EndPointSecurityRequirement[] s_SuppressionsBatchRemoveSecurityRequirements =
            new global::Resend.EndPointSecurityRequirement[]
            {                s_SuppressionsBatchRemoveSecurityRequirement0,
            };
        partial void PrepareSuppressionsBatchRemoveArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Resend.BatchRemoveSuppressionsOptions request);
        partial void PrepareSuppressionsBatchRemoveRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Resend.BatchRemoveSuppressionsOptions request);
        partial void ProcessSuppressionsBatchRemoveResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessSuppressionsBatchRemoveResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Resend.BatchRemoveSuppressionsResponseSuccess> SuppressionsBatchRemoveAsync(

            global::Resend.BatchRemoveSuppressionsOptions request,
            global::Resend.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await SuppressionsBatchRemoveAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Resend.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Resend.AutoSDKHttpResponse<global::Resend.BatchRemoveSuppressionsResponseSuccess>> SuppressionsBatchRemoveAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareSuppressionsBatchRemoveArguments(
            ...
            var __authorizations = global::Resend.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_SuppressionsBatchRemoveSecurityRequirements,
                operationName: "SuppressionsBatchRemoveAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareSuppressionsBatchRemoveRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Resend.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Resend.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "SuppressionsBatchRemove",
                                methodName: "SuppressionsBatchRemoveAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessSuppressionsBatchRemoveResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Resend.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessSuppressionsBatchRemoveResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await SuppressionsBatchRemoveAsync(
                request: __request,
                requestOptions: requestOptions,
