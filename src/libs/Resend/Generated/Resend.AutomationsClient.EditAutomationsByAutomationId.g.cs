...
namespace Resend
{
    public partial class AutomationsClient
    {
        ...
        private static readonly global::Resend.EndPointSecurityRequirement s_EditAutomationsByAutomationIdSecurityRequirement0 =
        ...
        private static readonly global::Resend.EndPointSecurityRequirement[] s_EditAutomationsByAutomationIdSecurityRequirements =
            new global::Resend.EndPointSecurityRequirement[]
            {                s_EditAutomationsByAutomationIdSecurityRequirement0,
            };
        partial void PrepareEditAutomationsByAutomationIdArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref global::System.Guid automationId,
            global::Resend.PatchAutomationRequest request);
        partial void PrepareEditAutomationsByAutomationIdRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::System.Guid automationId,
            global::Resend.PatchAutomationRequest request);
        partial void ProcessEditAutomationsByAutomationIdResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessEditAutomationsByAutomationIdResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Resend.PatchAutomationResponse> EditAutomationsByAutomationIdAsync(
            global::System.Guid automationId,
        ...
        {
            var __response = await EditAutomationsByAutomationIdAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Resend.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Resend.AutoSDKHttpResponse<global::Resend.PatchAutomationResponse>> EditAutomationsByAutomationIdAsResponseAsync(
            global::System.Guid automationId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareEditAutomationsByAutomationIdArguments(
            ...
            var __authorizations = global::Resend.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_EditAutomationsByAutomationIdSecurityRequirements,
                operationName: "EditAutomationsByAutomationIdAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Resend.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Resend.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "editAutomationsByAutomationId",
                                methodName: "EditAutomationsByAutomationIdAsync",
                                pathTemplate: "$\"/automations/{automationId}\"",
                                httpMethod: "PATCH",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessEditAutomationsByAutomationIdResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Resend.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessEditAutomationsByAutomationIdResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Resend.PatchAutomationResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Resend.AutoSDKHttpResponse<global::Resend.PatchAutomationResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Resend.PatchAutomationResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Resend.PatchAutomationResponse> EditAutomationsByAutomationIdAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Resend.PatchAutomationRequest
            {
                Name = name,
                Status = status,
                Steps = steps,
            ...
            return await EditAutomationsByAutomationIdAsync(
                automationId: automationId,
                request: __request,
                requestOptions: requestOptions,
