...
namespace Resend
{
    public partial class ContactsClient
    {
        ...
        private static readonly global::Resend.EndPointSecurityRequirement s_ContactsListTopicsSecurityRequirement0 =
        ...
        private static readonly global::Resend.EndPointSecurityRequirement[] s_ContactsListTopicsSecurityRequirements =
            new global::Resend.EndPointSecurityRequirement[]
            {                s_ContactsListTopicsSecurityRequirement0,
            };
        partial void PrepareContactsListTopicsArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string contactId,
            ref int? limit,
            ref string? after,
            ref string? before);
        partial void PrepareContactsListTopicsRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? after,
            string? before);
        partial void ProcessContactsListTopicsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessContactsListTopicsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Resend.GetContactTopicsResponseSuccess> ContactsListTopicsAsync(
            string contactId,
            int? limit = default,
        ...
        {
            var __response = await ContactsListTopicsAsResponseAsync(
                contactId: contactId,
                limit: limit,
                after: after,
                before: before,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Resend.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Resend.AutoSDKHttpResponse<global::Resend.GetContactTopicsResponseSuccess>> ContactsListTopicsAsResponseAsync(
            string contactId,
            int? limit = default,
            string? after = default,
            string? before = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareContactsListTopicsArguments(
            ...
            var __authorizations = global::Resend.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ContactsListTopicsSecurityRequirements,
                operationName: "ContactsListTopicsAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareContactsListTopicsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Resend.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Resend.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ContactsListTopics",
                                methodName: "ContactsListTopicsAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessContactsListTopicsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Resend.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessContactsListTopicsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
