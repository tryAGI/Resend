...
namespace Resend
{
    public partial class WebhooksClient
    {
        ...
        private static readonly global::Resend.EndPointSecurityRequirement s_WebhooksRotateSigningSecretSecurityRequirement0 =
        ...
        private static readonly global::Resend.EndPointSecurityRequirement[] s_WebhooksRotateSigningSecretSecurityRequirements =
            new global::Resend.EndPointSecurityRequirement[]
            {                s_WebhooksRotateSigningSecretSecurityRequirement0,
            };
        partial void PrepareWebhooksRotateSigningSecretArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref global::System.Guid webhookId);
        partial void PrepareWebhooksRotateSigningSecretRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::System.Guid webhookId);
        partial void ProcessWebhooksRotateSigningSecretResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessWebhooksRotateSigningSecretResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Resend.RotateWebhookSigningSecretResponse> WebhooksRotateSigningSecretAsync(
            global::System.Guid webhookId,
            global::Resend.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await WebhooksRotateSigningSecretAsResponseAsync(
                webhookId: webhookId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Resend.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Resend.AutoSDKHttpResponse<global::Resend.RotateWebhookSigningSecretResponse>> WebhooksRotateSigningSecretAsResponseAsync(
            global::System.Guid webhookId,
            global::Resend.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareWebhooksRotateSigningSecretArguments(
            ...
            var __authorizations = global::Resend.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_WebhooksRotateSigningSecretSecurityRequirements,
                operationName: "WebhooksRotateSigningSecretAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareWebhooksRotateSigningSecretRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Resend.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Resend.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "WebhooksRotateSigningSecret",
                                methodName: "WebhooksRotateSigningSecretAsync",
                                pathTemplate: "$\"/webhooks/{webhookId}/signing-secret/rotate\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessWebhooksRotateSigningSecretResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Resend.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessWebhooksRotateSigningSecretResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Resend.RotateWebhookSigningSecretResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Resend.AutoSDKHttpResponse<global::Resend.RotateWebhookSigningSecretResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Resend.RotateWebhookSigningSecretResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
