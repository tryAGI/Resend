...
namespace Resend
{
    public partial interface IEmailsClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Resend.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Resend.AutoSDKHttpResponse<global::Resend.RetrievedAttachment>> GetEmailsByEmailIdAttachmentsByAttachmentIdAsResponseAsync(
            global::System.Guid emailId,
            global::System.Guid attachmentId,
            global::Resend.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default);
