...
namespace Resend
{
    public partial class DomainsClient
    {
        ...
        private static readonly global::Resend.EndPointSecurityRequirement s_GetDomainsByDomainIdClaimSecurityRequirement0 =
        ...
        private static readonly global::Resend.EndPointSecurityRequirement[] s_GetDomainsByDomainIdClaimSecurityRequirements =
            new global::Resend.EndPointSecurityRequirement[]
            {                s_GetDomainsByDomainIdClaimSecurityRequirement0,
            };
        partial void PrepareGetDomainsByDomainIdClaimArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string domainId);
        partial void PrepareGetDomainsByDomainIdClaimRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string domainId);
        partial void ProcessGetDomainsByDomainIdClaimResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetDomainsByDomainIdClaimResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Resend.DomainClaim> GetDomainsByDomainIdClaimAsync(
            string domainId,
            global::Resend.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await GetDomainsByDomainIdClaimAsResponseAsync(
                domainId: domainId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Resend.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Resend.AutoSDKHttpResponse<global::Resend.DomainClaim>> GetDomainsByDomainIdClaimAsResponseAsync(
            string domainId,
            global::Resend.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetDomainsByDomainIdClaimArguments(
            ...
            var __authorizations = global::Resend.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetDomainsByDomainIdClaimSecurityRequirements,
                operationName: "GetDomainsByDomainIdClaimAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetDomainsByDomainIdClaimRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Resend.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Resend.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "getDomainsByDomainIdClaim",
                                methodName: "GetDomainsByDomainIdClaimAsync",
                                pathTemplate: "$\"/domains/{domainId}/claim\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetDomainsByDomainIdClaimResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Resend.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetDomainsByDomainIdClaimResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
