...
namespace Resend
{
    public partial class BroadcastsClient
    {
        ...
        private static readonly global::Resend.EndPointSecurityRequirement s_BroadcastsUpdateSecurityRequirement0 =
        ...
        private static readonly global::Resend.EndPointSecurityRequirement[] s_BroadcastsUpdateSecurityRequirements =
            new global::Resend.EndPointSecurityRequirement[]
            {                s_BroadcastsUpdateSecurityRequirement0,
            };
        partial void PrepareBroadcastsUpdateArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string id,
            global::Resend.UpdateBroadcastOptions request);
        partial void PrepareBroadcastsUpdateRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string id,
            global::Resend.UpdateBroadcastOptions request);
        partial void ProcessBroadcastsUpdateResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessBroadcastsUpdateResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Resend.UpdateBroadcastResponseSuccess> BroadcastsUpdateAsync(
            string id,
        ...
        {
            var __response = await BroadcastsUpdateAsResponseAsync(
                id: id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Resend.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Resend.AutoSDKHttpResponse<global::Resend.UpdateBroadcastResponseSuccess>> BroadcastsUpdateAsResponseAsync(
            string id,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareBroadcastsUpdateArguments(
            ...
            var __authorizations = global::Resend.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_BroadcastsUpdateSecurityRequirements,
                operationName: "BroadcastsUpdateAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareBroadcastsUpdateRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Resend.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Resend.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "BroadcastsUpdate",
                                methodName: "BroadcastsUpdateAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessBroadcastsUpdateResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Resend.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessBroadcastsUpdateResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Resend.UpdateBroadcastResponseSuccess.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Resend.AutoSDKHttpResponse<global::Resend.UpdateBroadcastResponseSuccess>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Resend.UpdateBroadcastResponseSuccess.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await BroadcastsUpdateAsync(
                id: id,
                request: __request,
                requestOptions: requestOptions,
