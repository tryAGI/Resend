...
namespace Resend
{
    ...
    public sealed class AutoSDKConditionalResponse<T>
    {
        internal AutoSDKConditionalResponse(
            bool notModified,
            string? entityTag,
            global::Resend.AutoSDKHttpResponse<T>? response)
        {
        ...
        public global::Resend.AutoSDKHttpResponse<T>? Response { get; }
    }
    ...
    public static class AutoSDKConditionalRequests
    {
        ...
        /// </summary>
        public static async global::System.Threading.Tasks.Task<global::Resend.AutoSDKConditionalResponse<T>> SendAsync<T>(
            global::System.Func<global::Resend.AutoSDKRequestOptions, global::System.Threading.CancellationToken, global::System.Threading.Tasks.Task<global::Resend.AutoSDKHttpResponse<T>>> send,
            string? entityTag = null,
            global::Resend.AutoSDKRequestOptions? requestOptions = null,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return new global::Resend.AutoSDKConditionalResponse<T>(
                    notModified: false,
                    entityTag: GetEntityTag(response.Headers),
                    response: response);
            }
            catch (global::Resend.ApiException exception)
        ...
        private static global::Resend.AutoSDKRequestOptions CloneRequestOptions(
            global::Resend.AutoSDKRequestOptions? source)
        {
            var clone = new global::Resend.AutoSDKRequestOptions();
            if (source == null)
            {
                return clone;
            }
