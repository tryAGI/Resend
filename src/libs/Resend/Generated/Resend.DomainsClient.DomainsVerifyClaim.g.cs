...
namespace Resend
{
    public partial class DomainsClient
    {
        ...
        private static readonly global::Resend.EndPointSecurityRequirement s_DomainsVerifyClaimSecurityRequirement0 =
        ...
        private static readonly global::Resend.EndPointSecurityRequirement[] s_DomainsVerifyClaimSecurityRequirements =
            new global::Resend.EndPointSecurityRequirement[]
            {                s_DomainsVerifyClaimSecurityRequirement0,
            };
        partial void PrepareDomainsVerifyClaimArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string domainId);
        partial void PrepareDomainsVerifyClaimRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string domainId);
        partial void ProcessDomainsVerifyClaimResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessDomainsVerifyClaimResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Resend.DomainClaim> DomainsVerifyClaimAsync(
            string domainId,
            global::Resend.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await DomainsVerifyClaimAsResponseAsync(
                domainId: domainId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Resend.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Resend.AutoSDKHttpResponse<global::Resend.DomainClaim>> DomainsVerifyClaimAsResponseAsync(
            string domainId,
            global::Resend.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareDomainsVerifyClaimArguments(
            ...
            var __authorizations = global::Resend.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_DomainsVerifyClaimSecurityRequirements,
                operationName: "DomainsVerifyClaimAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareDomainsVerifyClaimRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Resend.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Resend.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "DomainsVerifyClaim",
                                methodName: "DomainsVerifyClaimAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessDomainsVerifyClaimResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Resend.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessDomainsVerifyClaimResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
