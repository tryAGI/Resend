...
namespace Resend
{
    public partial class EmailsClient
    {
        ...
        private static readonly global::Resend.EndPointSecurityRequirement s_EmailsListAttachmentsSecurityRequirement0 =
        ...
        private static readonly global::Resend.EndPointSecurityRequirement[] s_EmailsListAttachmentsSecurityRequirements =
            new global::Resend.EndPointSecurityRequirement[]
            {                s_EmailsListAttachmentsSecurityRequirement0,
            };
        partial void PrepareEmailsListAttachmentsArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref global::System.Guid emailId,
            ref int? limit,
            ref global::System.Guid? after,
            ref global::System.Guid? before);
        partial void PrepareEmailsListAttachmentsRequest(
            global::System.Net.Http.HttpClient httpClient,
        ...
        partial void ProcessEmailsListAttachmentsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessEmailsListAttachmentsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Resend.ListAttachmentsResponse> EmailsListAttachmentsAsync(
            global::System.Guid emailId,
            int? limit = default,
        ...
        {
            var __response = await EmailsListAttachmentsAsResponseAsync(
                emailId: emailId,
                limit: limit,
                after: after,
                before: before,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Resend.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Resend.AutoSDKHttpResponse<global::Resend.ListAttachmentsResponse>> EmailsListAttachmentsAsResponseAsync(
            global::System.Guid emailId,
            int? limit = default,
            global::System.Guid? after = default,
            global::System.Guid? before = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareEmailsListAttachmentsArguments(
            ...
            var __authorizations = global::Resend.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_EmailsListAttachmentsSecurityRequirements,
                operationName: "EmailsListAttachmentsAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareEmailsListAttachmentsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Resend.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Resend.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "EmailsListAttachments",
                                methodName: "EmailsListAttachmentsAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessEmailsListAttachmentsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Resend.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessEmailsListAttachmentsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
