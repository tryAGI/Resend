...
namespace Resend
{
    public partial interface IContactsClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Resend.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Resend.AutoSDKHttpResponse<global::Resend.ListContactSegmentsResponseSuccess>> GetContactsByContactIdSegmentsAsResponseAsync(
            string contactId,
            int? limit = default,
            string? after = default,
            string? before = default,
