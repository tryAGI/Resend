...
namespace Resend
{
    public partial class WebhooksClient
    {
        ...
        private static readonly global::Resend.EndPointSecurityRequirement s_WebhooksGetEventSecurityRequirement0 =
        ...
        private static readonly global::Resend.EndPointSecurityRequirement[] s_WebhooksGetEventSecurityRequirements =
            new global::Resend.EndPointSecurityRequirement[]
            {                s_WebhooksGetEventSecurityRequirement0,
            };
        partial void PrepareWebhooksGetEventArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref global::System.Guid webhookId,
            ref string eventId);
        partial void PrepareWebhooksGetEventRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::System.Guid webhookId,
            string eventId);
        partial void ProcessWebhooksGetEventResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessWebhooksGetEventResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Resend.GetWebhookEventResponse> WebhooksGetEventAsync(
            global::System.Guid webhookId,
            string eventId,
            global::Resend.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await WebhooksGetEventAsResponseAsync(
                webhookId: webhookId,
                eventId: eventId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Resend.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Resend.AutoSDKHttpResponse<global::Resend.GetWebhookEventResponse>> WebhooksGetEventAsResponseAsync(
            global::System.Guid webhookId,
            string eventId,
            global::Resend.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareWebhooksGetEventArguments(
            ...
            var __authorizations = global::Resend.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_WebhooksGetEventSecurityRequirements,
                operationName: "WebhooksGetEventAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareWebhooksGetEventRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Resend.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Resend.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "WebhooksGetEvent",
                                methodName: "WebhooksGetEventAsync",
                                pathTemplate: "$\"/webhooks/{webhookId}/events/{eventId}\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessWebhooksGetEventResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Resend.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessWebhooksGetEventResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Resend.GetWebhookEventResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Resend.AutoSDKHttpResponse<global::Resend.GetWebhookEventResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Resend.GetWebhookEventResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
