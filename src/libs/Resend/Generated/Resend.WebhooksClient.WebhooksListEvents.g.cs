...
namespace Resend
{
    public partial class WebhooksClient
    {
        ...
        private static readonly global::Resend.EndPointSecurityRequirement s_WebhooksListEventsSecurityRequirement0 =
        ...
        private static readonly global::Resend.EndPointSecurityRequirement[] s_WebhooksListEventsSecurityRequirements =
            new global::Resend.EndPointSecurityRequirement[]
            {                s_WebhooksListEventsSecurityRequirement0,
            };
        partial void PrepareWebhooksListEventsArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref global::System.Guid webhookId,
            ref int? limit,
            ref string? after);
        partial void PrepareWebhooksListEventsRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::System.Guid webhookId,
            int? limit,
            string? after);
        partial void ProcessWebhooksListEventsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessWebhooksListEventsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Resend.ListWebhookEventsResponse> WebhooksListEventsAsync(
            global::System.Guid webhookId,
            int? limit = default,
        ...
        {
            var __response = await WebhooksListEventsAsResponseAsync(
                webhookId: webhookId,
                limit: limit,
                after: after,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Resend.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Resend.AutoSDKHttpResponse<global::Resend.ListWebhookEventsResponse>> WebhooksListEventsAsResponseAsync(
            global::System.Guid webhookId,
            int? limit = default,
            string? after = default,
            global::Resend.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareWebhooksListEventsArguments(
            ...
            var __authorizations = global::Resend.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_WebhooksListEventsSecurityRequirements,
                operationName: "WebhooksListEventsAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareWebhooksListEventsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Resend.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Resend.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "WebhooksListEvents",
                                methodName: "WebhooksListEventsAsync",
                                pathTemplate: "$\"/webhooks/{webhookId}/events\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessWebhooksListEventsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Resend.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessWebhooksListEventsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Resend.ListWebhookEventsResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Resend.AutoSDKHttpResponse<global::Resend.ListWebhookEventsResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Resend.ListWebhookEventsResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
