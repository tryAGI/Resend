...
namespace Resend
{
    public partial class EmailsClient
    {
        ...
        private static readonly global::Resend.EndPointSecurityRequirement s_EmailsGetAttachmentSecurityRequirement0 =
        ...
        private static readonly global::Resend.EndPointSecurityRequirement[] s_EmailsGetAttachmentSecurityRequirements =
            new global::Resend.EndPointSecurityRequirement[]
            {                s_EmailsGetAttachmentSecurityRequirement0,
            };
        partial void PrepareEmailsGetAttachmentArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref global::System.Guid emailId,
            ref global::System.Guid attachmentId);
        partial void PrepareEmailsGetAttachmentRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::System.Guid emailId,
            global::System.Guid attachmentId);
        partial void ProcessEmailsGetAttachmentResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessEmailsGetAttachmentResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Resend.RetrievedAttachment> EmailsGetAttachmentAsync(
            global::System.Guid emailId,
            global::System.Guid attachmentId,
            global::Resend.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await EmailsGetAttachmentAsResponseAsync(
                emailId: emailId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Resend.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Resend.AutoSDKHttpResponse<global::Resend.RetrievedAttachment>> EmailsGetAttachmentAsResponseAsync(
            global::System.Guid emailId,
            global::System.Guid attachmentId,
            global::Resend.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareEmailsGetAttachmentArguments(
            ...
            var __authorizations = global::Resend.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_EmailsGetAttachmentSecurityRequirements,
                operationName: "EmailsGetAttachmentAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareEmailsGetAttachmentRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Resend.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Resend.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "EmailsGetAttachment",
                                methodName: "EmailsGetAttachmentAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessEmailsGetAttachmentResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Resend.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessEmailsGetAttachmentResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
