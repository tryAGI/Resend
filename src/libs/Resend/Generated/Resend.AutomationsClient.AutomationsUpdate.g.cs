...
namespace Resend
{
    public partial class AutomationsClient
    {
        ...
        private static readonly global::Resend.EndPointSecurityRequirement s_AutomationsUpdateSecurityRequirement0 =
        ...
        private static readonly global::Resend.EndPointSecurityRequirement[] s_AutomationsUpdateSecurityRequirements =
            new global::Resend.EndPointSecurityRequirement[]
            {                s_AutomationsUpdateSecurityRequirement0,
            };
        partial void PrepareAutomationsUpdateArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref global::System.Guid automationId,
            global::Resend.PatchAutomationRequest request);
        partial void PrepareAutomationsUpdateRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::System.Guid automationId,
            global::Resend.PatchAutomationRequest request);
        partial void ProcessAutomationsUpdateResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessAutomationsUpdateResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Resend.PatchAutomationResponse> AutomationsUpdateAsync(
            global::System.Guid automationId,
        ...
        {
            var __response = await AutomationsUpdateAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Resend.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Resend.AutoSDKHttpResponse<global::Resend.PatchAutomationResponse>> AutomationsUpdateAsResponseAsync(
            global::System.Guid automationId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareAutomationsUpdateArguments(
            ...
            var __authorizations = global::Resend.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_AutomationsUpdateSecurityRequirements,
                operationName: "AutomationsUpdateAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareAutomationsUpdateRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Resend.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Resend.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "AutomationsUpdateAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessAutomationsUpdateResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Resend.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessAutomationsUpdateResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await AutomationsUpdateAsync(
                automationId: automationId,
                request: __request,
                requestOptions: requestOptions,
