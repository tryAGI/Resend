...
namespace Resend
{
    public partial class EmailsClient
    {
        ...
        private static readonly global::Resend.EndPointSecurityRequirement s_EmailsSendBatchSecurityRequirement0 =
        ...
        private static readonly global::Resend.EndPointSecurityRequirement[] s_EmailsSendBatchSecurityRequirements =
            new global::Resend.EndPointSecurityRequirement[]
            {                s_EmailsSendBatchSecurityRequirement0,
            };
        partial void PrepareEmailsSendBatchArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string? idempotencyKey,
            global::System.Collections.Generic.IList<global::Resend.SendEmailRequest> request);
        partial void PrepareEmailsSendBatchRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string? idempotencyKey,
            global::System.Collections.Generic.IList<global::Resend.SendEmailRequest> request);
        partial void ProcessEmailsSendBatchResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessEmailsSendBatchResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Resend.CreateBatchEmailsResponse> EmailsSendBatchAsync(
        ...
        {
            var __response = await EmailsSendBatchAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Resend.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Resend.AutoSDKHttpResponse<global::Resend.CreateBatchEmailsResponse>> EmailsSendBatchAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareEmailsSendBatchArguments(
            ...
            var __authorizations = global::Resend.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_EmailsSendBatchSecurityRequirements,
                operationName: "EmailsSendBatchAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Resend.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Resend.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "EmailsSendBatch",
                                methodName: "EmailsSendBatchAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessEmailsSendBatchResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Resend.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessEmailsSendBatchResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Resend.CreateBatchEmailsResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Resend.AutoSDKHttpResponse<global::Resend.CreateBatchEmailsResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Resend.CreateBatchEmailsResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
