...
namespace Resend
{
    public partial class BroadcastsClient
    {
        ...
        private static readonly global::Resend.EndPointSecurityRequirement s_CreateBroadcastsByIdSendSecurityRequirement0 =
        ...
        private static readonly global::Resend.EndPointSecurityRequirement[] s_CreateBroadcastsByIdSendSecurityRequirements =
            new global::Resend.EndPointSecurityRequirement[]
            {                s_CreateBroadcastsByIdSendSecurityRequirement0,
            };
        partial void PrepareCreateBroadcastsByIdSendArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string id,
            global::Resend.SendBroadcastOptions request);
        partial void PrepareCreateBroadcastsByIdSendRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string id,
            global::Resend.SendBroadcastOptions request);
        partial void ProcessCreateBroadcastsByIdSendResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCreateBroadcastsByIdSendResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Resend.SendBroadcastResponseSuccess> CreateBroadcastsByIdSendAsync(
            string id,
        ...
        {
            var __response = await CreateBroadcastsByIdSendAsResponseAsync(
                id: id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Resend.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Resend.AutoSDKHttpResponse<global::Resend.SendBroadcastResponseSuccess>> CreateBroadcastsByIdSendAsResponseAsync(
            string id,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreateBroadcastsByIdSendArguments(
            ...
            var __authorizations = global::Resend.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateBroadcastsByIdSendSecurityRequirements,
                operationName: "CreateBroadcastsByIdSendAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreateBroadcastsByIdSendRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Resend.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Resend.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "createBroadcastsByIdSend",
                                methodName: "CreateBroadcastsByIdSendAsync",
                                pathTemplate: "$\"/broadcasts/{id}/send\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateBroadcastsByIdSendResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Resend.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreateBroadcastsByIdSendResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Resend.SendBroadcastResponseSuccess.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Resend.AutoSDKHttpResponse<global::Resend.SendBroadcastResponseSuccess>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Resend.SendBroadcastResponseSuccess.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await CreateBroadcastsByIdSendAsync(
                id: id,
                request: __request,
                requestOptions: requestOptions,
