...
namespace Resend
{
    public partial class ReceivingEmailsClient
    {
        ...
        private static readonly global::Resend.EndPointSecurityRequirement s_EmailsListReceivingSecurityRequirement0 =
        ...
        private static readonly global::Resend.EndPointSecurityRequirement[] s_EmailsListReceivingSecurityRequirements =
            new global::Resend.EndPointSecurityRequirement[]
            {                s_EmailsListReceivingSecurityRequirement0,
            };
        partial void PrepareEmailsListReceivingArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref int? limit,
            ref global::System.Guid? after,
            ref global::System.Guid? before);
        partial void PrepareEmailsListReceivingRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            int? limit,
            global::System.Guid? after,
            global::System.Guid? before);
        partial void ProcessEmailsListReceivingResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessEmailsListReceivingResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Resend.ListReceivedEmailsResponse> EmailsListReceivingAsync(
            int? limit = default,
        ...
        {
            var __response = await EmailsListReceivingAsResponseAsync(
                limit: limit,
                after: after,
                before: before,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Resend.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Resend.AutoSDKHttpResponse<global::Resend.ListReceivedEmailsResponse>> EmailsListReceivingAsResponseAsync(
            int? limit = default,
            global::System.Guid? after = default,
            global::System.Guid? before = default,
            global::Resend.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareEmailsListReceivingArguments(
            ...
            var __authorizations = global::Resend.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_EmailsListReceivingSecurityRequirements,
                operationName: "EmailsListReceivingAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareEmailsListReceivingRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Resend.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Resend.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "EmailsListReceiving",
                                methodName: "EmailsListReceivingAsync",
                                pathTemplate: "\"/emails/receiving\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessEmailsListReceivingResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Resend.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessEmailsListReceivingResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Resend.ListReceivedEmailsResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Resend.AutoSDKHttpResponse<global::Resend.ListReceivedEmailsResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Resend.ListReceivedEmailsResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
