...
namespace Resend
{
    public partial class AutomationsClient
    {
        ...
        private static readonly global::Resend.EndPointSecurityRequirement s_AutomationsListRunsSecurityRequirement0 =
        ...
        private static readonly global::Resend.EndPointSecurityRequirement[] s_AutomationsListRunsSecurityRequirements =
            new global::Resend.EndPointSecurityRequirement[]
            {                s_AutomationsListRunsSecurityRequirement0,
            };
        partial void PrepareAutomationsListRunsArguments(
            ...
            ref string? after,
            ref string? before);
        partial void PrepareAutomationsListRunsRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? after,
            string? before);
        partial void ProcessAutomationsListRunsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessAutomationsListRunsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Resend.ListAutomationRunsResponse> AutomationsListRunsAsync(
            global::System.Guid automationId,
        ...
        {
            var __response = await AutomationsListRunsAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Resend.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Resend.AutoSDKHttpResponse<global::Resend.ListAutomationRunsResponse>> AutomationsListRunsAsResponseAsync(
            global::System.Guid automationId,
            string? status = default,
            int? limit = default,
            string? after = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareAutomationsListRunsArguments(
            ...
            var __authorizations = global::Resend.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_AutomationsListRunsSecurityRequirements,
                operationName: "AutomationsListRunsAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareAutomationsListRunsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Resend.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Resend.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "AutomationsListRuns",
                                methodName: "AutomationsListRunsAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessAutomationsListRunsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Resend.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessAutomationsListRunsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
