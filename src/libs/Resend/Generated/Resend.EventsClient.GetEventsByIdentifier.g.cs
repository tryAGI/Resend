...
namespace Resend
{
    public partial class EventsClient
    {
        ...
        private static readonly global::Resend.EndPointSecurityRequirement s_GetEventsByIdentifierSecurityRequirement0 =
        ...
        private static readonly global::Resend.EndPointSecurityRequirement[] s_GetEventsByIdentifierSecurityRequirements =
            new global::Resend.EndPointSecurityRequirement[]
            {                s_GetEventsByIdentifierSecurityRequirement0,
            };
        partial void PrepareGetEventsByIdentifierArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string identifier);
        partial void PrepareGetEventsByIdentifierRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string identifier);
        partial void ProcessGetEventsByIdentifierResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetEventsByIdentifierResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Resend.Event> GetEventsByIdentifierAsync(
            string identifier,
            global::Resend.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await GetEventsByIdentifierAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Resend.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Resend.AutoSDKHttpResponse<global::Resend.Event>> GetEventsByIdentifierAsResponseAsync(
            string identifier,
            global::Resend.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetEventsByIdentifierArguments(
            ...
            var __authorizations = global::Resend.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetEventsByIdentifierSecurityRequirements,
                operationName: "GetEventsByIdentifierAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetEventsByIdentifierRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Resend.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Resend.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GetEventsByIdentifierAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetEventsByIdentifierResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Resend.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetEventsByIdentifierResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Resend.Event.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Resend.AutoSDKHttpResponse<global::Resend.Event>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Resend.Event.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
