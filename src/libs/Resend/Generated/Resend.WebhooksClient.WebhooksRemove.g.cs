...
namespace Resend
{
    public partial class WebhooksClient
    {
        ...
        private static readonly global::Resend.EndPointSecurityRequirement s_WebhooksRemoveSecurityRequirement0 =
        ...
        private static readonly global::Resend.EndPointSecurityRequirement[] s_WebhooksRemoveSecurityRequirements =
            new global::Resend.EndPointSecurityRequirement[]
            {                s_WebhooksRemoveSecurityRequirement0,
            };
        partial void PrepareWebhooksRemoveArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref global::System.Guid webhookId);
        partial void PrepareWebhooksRemoveRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::System.Guid webhookId);
        partial void ProcessWebhooksRemoveResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessWebhooksRemoveResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Resend.DeleteWebhookResponse> WebhooksRemoveAsync(
            global::System.Guid webhookId,
            global::Resend.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await WebhooksRemoveAsResponseAsync(
                webhookId: webhookId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Resend.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Resend.AutoSDKHttpResponse<global::Resend.DeleteWebhookResponse>> WebhooksRemoveAsResponseAsync(
            global::System.Guid webhookId,
            global::Resend.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareWebhooksRemoveArguments(
            ...
            var __authorizations = global::Resend.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_WebhooksRemoveSecurityRequirements,
                operationName: "WebhooksRemoveAsync");
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Resend.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Resend.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "WebhooksRemove",
                                methodName: "WebhooksRemoveAsync",
                ...
                else
                {
                    await global::Resend.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessWebhooksRemoveResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Resend.DeleteWebhookResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Resend.AutoSDKHttpResponse<global::Resend.DeleteWebhookResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Resend.DeleteWebhookResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
