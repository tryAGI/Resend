...
namespace Resend
{
    public partial class SuppressionsClient
    {
        ...
        private static readonly global::Resend.EndPointSecurityRequirement s_SuppressionsRemoveSecurityRequirement0 =
        ...
        private static readonly global::Resend.EndPointSecurityRequirement[] s_SuppressionsRemoveSecurityRequirements =
            new global::Resend.EndPointSecurityRequirement[]
            {                s_SuppressionsRemoveSecurityRequirement0,
            };
        partial void PrepareSuppressionsRemoveArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string suppression);
        partial void PrepareSuppressionsRemoveRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string suppression);
        partial void ProcessSuppressionsRemoveResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessSuppressionsRemoveResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Resend.RemoveSuppressionResponseSuccess> SuppressionsRemoveAsync(
            string suppression,
            global::Resend.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await SuppressionsRemoveAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Resend.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Resend.AutoSDKHttpResponse<global::Resend.RemoveSuppressionResponseSuccess>> SuppressionsRemoveAsResponseAsync(
            string suppression,
            global::Resend.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareSuppressionsRemoveArguments(
            ...
            var __authorizations = global::Resend.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_SuppressionsRemoveSecurityRequirements,
                operationName: "SuppressionsRemoveAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareSuppressionsRemoveRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Resend.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Resend.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "SuppressionsRemove",
                                methodName: "SuppressionsRemoveAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessSuppressionsRemoveResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Resend.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessSuppressionsRemoveResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
