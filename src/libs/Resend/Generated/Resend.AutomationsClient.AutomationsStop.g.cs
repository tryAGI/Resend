...
namespace Resend
{
    public partial class AutomationsClient
    {
        ...
        private static readonly global::Resend.EndPointSecurityRequirement s_AutomationsStopSecurityRequirement0 =
        ...
        private static readonly global::Resend.EndPointSecurityRequirement[] s_AutomationsStopSecurityRequirements =
            new global::Resend.EndPointSecurityRequirement[]
            {                s_AutomationsStopSecurityRequirement0,
            };
        partial void PrepareAutomationsStopArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref global::System.Guid automationId);
        partial void PrepareAutomationsStopRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::System.Guid automationId);
        partial void ProcessAutomationsStopResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessAutomationsStopResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Resend.StopAutomationResponse> AutomationsStopAsync(
            global::System.Guid automationId,
            global::Resend.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await AutomationsStopAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Resend.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Resend.AutoSDKHttpResponse<global::Resend.StopAutomationResponse>> AutomationsStopAsResponseAsync(
            global::System.Guid automationId,
            global::Resend.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareAutomationsStopArguments(
            ...
            var __authorizations = global::Resend.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_AutomationsStopSecurityRequirements,
                operationName: "AutomationsStopAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Resend.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Resend.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "AutomationsStop",
                                methodName: "AutomationsStopAsync",
                                pathTemplate: "$\"/automations/{automationId}/stop\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessAutomationsStopResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Resend.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessAutomationsStopResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Resend.StopAutomationResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Resend.AutoSDKHttpResponse<global::Resend.StopAutomationResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Resend.StopAutomationResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
