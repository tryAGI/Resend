...
namespace Resend
{
    public partial class EmailsClient
    {
        ...
        private static readonly global::Resend.EndPointSecurityRequirement s_EmailsShareSecurityRequirement0 =
        ...
        private static readonly global::Resend.EndPointSecurityRequirement[] s_EmailsShareSecurityRequirements =
            new global::Resend.EndPointSecurityRequirement[]
            {                s_EmailsShareSecurityRequirement0,
            };
        partial void PrepareEmailsShareArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string emailId,
            global::Resend.ShareEmailOptions request);
        partial void PrepareEmailsShareRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string emailId,
            global::Resend.ShareEmailOptions request);
        partial void ProcessEmailsShareResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessEmailsShareResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Resend.ShareEmailResponse> EmailsShareAsync(
            string emailId,
        ...
        {
            var __response = await EmailsShareAsResponseAsync(
                emailId: emailId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Resend.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Resend.AutoSDKHttpResponse<global::Resend.ShareEmailResponse>> EmailsShareAsResponseAsync(
            string emailId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::Resend.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_EmailsShareSecurityRequirements,
                operationName: "EmailsShareAsync");
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Resend.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Resend.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "EmailsShare",
                                methodName: "EmailsShareAsync",
                                pathTemplate: "$\"/emails/{emailId}/share\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::Resend.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessEmailsShareResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Resend.ShareEmailResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Resend.AutoSDKHttpResponse<global::Resend.ShareEmailResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Resend.ShareEmailResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Resend.ShareEmailResponse> EmailsShareAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Resend.ShareEmailOptions
            {
                ExpiresIn = expiresIn,
            };

            return await EmailsShareAsync(
                emailId: emailId,
                request: __request,
                requestOptions: requestOptions,
