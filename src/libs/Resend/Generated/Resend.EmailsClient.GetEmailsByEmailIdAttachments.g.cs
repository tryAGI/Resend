...
namespace Resend
{
    public partial class EmailsClient
    {
        ...
        private static readonly global::Resend.EndPointSecurityRequirement s_GetEmailsByEmailIdAttachmentsSecurityRequirement0 =
        ...
        private static readonly global::Resend.EndPointSecurityRequirement[] s_GetEmailsByEmailIdAttachmentsSecurityRequirements =
            new global::Resend.EndPointSecurityRequirement[]
            {                s_GetEmailsByEmailIdAttachmentsSecurityRequirement0,
            };
        partial void PrepareGetEmailsByEmailIdAttachmentsArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref global::System.Guid emailId,
            ref int? limit,
            ref global::System.Guid? after,
            ref global::System.Guid? before);
        partial void PrepareGetEmailsByEmailIdAttachmentsRequest(
            global::System.Net.Http.HttpClient httpClient,
        ...
        partial void ProcessGetEmailsByEmailIdAttachmentsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetEmailsByEmailIdAttachmentsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Resend.ListAttachmentsResponse> GetEmailsByEmailIdAttachmentsAsync(
            global::System.Guid emailId,
            int? limit = default,
        ...
        {
            var __response = await GetEmailsByEmailIdAttachmentsAsResponseAsync(
                emailId: emailId,
                limit: limit,
                after: after,
                before: before,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Resend.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Resend.AutoSDKHttpResponse<global::Resend.ListAttachmentsResponse>> GetEmailsByEmailIdAttachmentsAsResponseAsync(
            global::System.Guid emailId,
            int? limit = default,
            global::System.Guid? after = default,
            global::System.Guid? before = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetEmailsByEmailIdAttachmentsArguments(
            ...
            var __authorizations = global::Resend.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetEmailsByEmailIdAttachmentsSecurityRequirements,
                operationName: "GetEmailsByEmailIdAttachmentsAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Resend.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Resend.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "getEmailsByEmailIdAttachments",
                                methodName: "GetEmailsByEmailIdAttachmentsAsync",
                                pathTemplate: "$\"/emails/{emailId}/attachments\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetEmailsByEmailIdAttachmentsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Resend.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetEmailsByEmailIdAttachmentsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
