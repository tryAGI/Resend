...
namespace Resend
{
    public partial class ReceivingEmailsClient
    {
        ...
        private static readonly global::Resend.EndPointSecurityRequirement s_EmailsGetReceivingSecurityRequirement0 =
        ...
        private static readonly global::Resend.EndPointSecurityRequirement[] s_EmailsGetReceivingSecurityRequirements =
            new global::Resend.EndPointSecurityRequirement[]
            {                s_EmailsGetReceivingSecurityRequirement0,
            };
        partial void PrepareEmailsGetReceivingArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref global::System.Guid emailId);
        partial void PrepareEmailsGetReceivingRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::System.Guid emailId);
        partial void ProcessEmailsGetReceivingResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessEmailsGetReceivingResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Resend.GetReceivedEmailResponse> EmailsGetReceivingAsync(
            global::System.Guid emailId,
            global::Resend.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await EmailsGetReceivingAsResponseAsync(
                emailId: emailId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Resend.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Resend.AutoSDKHttpResponse<global::Resend.GetReceivedEmailResponse>> EmailsGetReceivingAsResponseAsync(
            global::System.Guid emailId,
            global::Resend.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareEmailsGetReceivingArguments(
            ...
            var __authorizations = global::Resend.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_EmailsGetReceivingSecurityRequirements,
                operationName: "EmailsGetReceivingAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareEmailsGetReceivingRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Resend.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Resend.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "EmailsGetReceiving",
                                methodName: "EmailsGetReceivingAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessEmailsGetReceivingResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Resend.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessEmailsGetReceivingResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
