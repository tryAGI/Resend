...
namespace Resend
{
    public partial class ContactsClient
    {
        ...
        private static readonly global::Resend.EndPointSecurityRequirement s_ContactsListSegmentsSecurityRequirement0 =
        ...
        private static readonly global::Resend.EndPointSecurityRequirement[] s_ContactsListSegmentsSecurityRequirements =
            new global::Resend.EndPointSecurityRequirement[]
            {                s_ContactsListSegmentsSecurityRequirement0,
            };
        partial void PrepareContactsListSegmentsArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string contactId,
            ref int? limit,
            ref string? after,
            ref string? before);
        partial void PrepareContactsListSegmentsRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? after,
            string? before);
        partial void ProcessContactsListSegmentsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessContactsListSegmentsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Resend.ListContactSegmentsResponseSuccess> ContactsListSegmentsAsync(
            string contactId,
            int? limit = default,
        ...
        {
            var __response = await ContactsListSegmentsAsResponseAsync(
                contactId: contactId,
                limit: limit,
                after: after,
                before: before,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Resend.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Resend.AutoSDKHttpResponse<global::Resend.ListContactSegmentsResponseSuccess>> ContactsListSegmentsAsResponseAsync(
            string contactId,
            int? limit = default,
            string? after = default,
            string? before = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareContactsListSegmentsArguments(
            ...
            var __authorizations = global::Resend.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ContactsListSegmentsSecurityRequirements,
                operationName: "ContactsListSegmentsAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareContactsListSegmentsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Resend.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Resend.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "ContactsListSegmentsAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessContactsListSegmentsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Resend.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessContactsListSegmentsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
