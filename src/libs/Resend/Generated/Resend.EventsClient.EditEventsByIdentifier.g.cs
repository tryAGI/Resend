...
namespace Resend
{
    public partial class EventsClient
    {
        ...
        private static readonly global::Resend.EndPointSecurityRequirement s_EditEventsByIdentifierSecurityRequirement0 =
        ...
        private static readonly global::Resend.EndPointSecurityRequirement[] s_EditEventsByIdentifierSecurityRequirements =
            new global::Resend.EndPointSecurityRequirement[]
            {                s_EditEventsByIdentifierSecurityRequirement0,
            };
        partial void PrepareEditEventsByIdentifierArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string identifier,
            global::Resend.UpdateEventRequest request);
        partial void PrepareEditEventsByIdentifierRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string identifier,
            global::Resend.UpdateEventRequest request);
        partial void ProcessEditEventsByIdentifierResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessEditEventsByIdentifierResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Resend.UpdateEventResponse> EditEventsByIdentifierAsync(
            string identifier,
        ...
        {
            var __response = await EditEventsByIdentifierAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Resend.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Resend.AutoSDKHttpResponse<global::Resend.UpdateEventResponse>> EditEventsByIdentifierAsResponseAsync(
            string identifier,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareEditEventsByIdentifierArguments(
            ...
            var __authorizations = global::Resend.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_EditEventsByIdentifierSecurityRequirements,
                operationName: "EditEventsByIdentifierAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Resend.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Resend.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "editEventsByIdentifier",
                                methodName: "EditEventsByIdentifierAsync",
                                pathTemplate: "$\"/events/{identifier}\"",
                                httpMethod: "PATCH",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessEditEventsByIdentifierResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Resend.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessEditEventsByIdentifierResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Resend.UpdateEventResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Resend.AutoSDKHttpResponse<global::Resend.UpdateEventResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Resend.UpdateEventResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Resend.UpdateEventResponse> EditEventsByIdentifierAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Resend.UpdateEventRequest
            {
                Schema = schema,
            };

            return await EditEventsByIdentifierAsync(
                identifier: identifier,
                request: __request,
                requestOptions: requestOptions,
