...
namespace Resend
{
    public partial class AutomationsClient
    {
        ...
        private static readonly global::Resend.EndPointSecurityRequirement s_AutomationsGetRunSecurityRequirement0 =
        ...
        private static readonly global::Resend.EndPointSecurityRequirement[] s_AutomationsGetRunSecurityRequirements =
            new global::Resend.EndPointSecurityRequirement[]
            {                s_AutomationsGetRunSecurityRequirement0,
            };
        partial void PrepareAutomationsGetRunArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref global::System.Guid automationId,
            ref global::System.Guid runId);
        partial void PrepareAutomationsGetRunRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::System.Guid automationId,
            global::System.Guid runId);
        partial void ProcessAutomationsGetRunResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessAutomationsGetRunResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Resend.AutomationRun> AutomationsGetRunAsync(
            global::System.Guid automationId,
            global::System.Guid runId,
            global::Resend.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await AutomationsGetRunAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Resend.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Resend.AutoSDKHttpResponse<global::Resend.AutomationRun>> AutomationsGetRunAsResponseAsync(
            global::System.Guid automationId,
            global::System.Guid runId,
            global::Resend.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareAutomationsGetRunArguments(
            ...
            var __authorizations = global::Resend.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_AutomationsGetRunSecurityRequirements,
                operationName: "AutomationsGetRunAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareAutomationsGetRunRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Resend.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Resend.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "AutomationsGetRun",
                                methodName: "AutomationsGetRunAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessAutomationsGetRunResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Resend.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessAutomationsGetRunResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
