...
namespace Resend
{
    public partial class ContactPropertiesClient
    {
        ...
        private static readonly global::Resend.EndPointSecurityRequirement s_ContactPropertiesCreateSecurityRequirement0 =
        ...
        private static readonly global::Resend.EndPointSecurityRequirement[] s_ContactPropertiesCreateSecurityRequirements =
            new global::Resend.EndPointSecurityRequirement[]
            {                s_ContactPropertiesCreateSecurityRequirement0,
            };
        partial void PrepareContactPropertiesCreateArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Resend.CreateContactPropertyOptions request);
        partial void PrepareContactPropertiesCreateRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Resend.CreateContactPropertyOptions request);
        partial void ProcessContactPropertiesCreateResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessContactPropertiesCreateResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Resend.CreateContactPropertyResponseSuccess> ContactPropertiesCreateAsync(

            global::Resend.CreateContactPropertyOptions request,
            global::Resend.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await ContactPropertiesCreateAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Resend.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Resend.AutoSDKHttpResponse<global::Resend.CreateContactPropertyResponseSuccess>> ContactPropertiesCreateAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareContactPropertiesCreateArguments(
            ...
            var __authorizations = global::Resend.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ContactPropertiesCreateSecurityRequirements,
                operationName: "ContactPropertiesCreateAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareContactPropertiesCreateRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Resend.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Resend.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ContactPropertiesCreate",
                                methodName: "ContactPropertiesCreateAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessContactPropertiesCreateResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Resend.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessContactPropertiesCreateResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await ContactPropertiesCreateAsync(
                request: __request,
                requestOptions: requestOptions,
