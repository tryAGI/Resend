...
namespace Resend
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::Resend.AutoSDKRetryOptions Retry { get; set; } = new global::Resend.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::Resend.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::Resend.IAutoSDKHook>();
        ...
        public global::Resend.AutoSDKClientOptions AddHook(
            global::Resend.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::Resend.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::Resend.AutoSDKClientOptions UseAuthorizationProvider(
            global::Resend.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::Resend.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::Resend.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::Resend.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::Resend.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::Resend.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::Resend.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::Resend.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::Resend.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::Resend.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::Resend.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::Resend.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::Resend.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::Resend.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::Resend.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::Resend.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::Resend.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::Resend.AutoSDKClientOptions clientOptions,
            global::Resend.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::Resend.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::Resend.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::Resend.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::Resend.AutoSDKClientOptions clientOptions,
            global::System.Func<global::Resend.IAutoSDKHook, global::Resend.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::Resend.AutoSDKHookContext context)
        {
