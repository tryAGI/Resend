...
namespace Resend
{
    public partial interface IReceivingEmailsClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Resend.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Resend.AutoSDKHttpResponse<global::Resend.GetReceivedEmailResponse>> GetEmailsReceivingByEmailIdAsResponseAsync(
            global::System.Guid emailId,
            global::Resend.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default);
    }
