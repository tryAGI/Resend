...
namespace Resend
{
    public partial class ReceivingEmailsClient
    {
        ...
        private static readonly global::Resend.EndPointSecurityRequirement s_EmailsListReceivingAttachmentsSecurityRequirement0 =
        ...
        private static readonly global::Resend.EndPointSecurityRequirement[] s_EmailsListReceivingAttachmentsSecurityRequirements =
            new global::Resend.EndPointSecurityRequirement[]
            {                s_EmailsListReceivingAttachmentsSecurityRequirement0,
            };
        partial void PrepareEmailsListReceivingAttachmentsArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref global::System.Guid emailId,
            ref int? limit,
            ref global::System.Guid? after,
            ref global::System.Guid? before);
        partial void PrepareEmailsListReceivingAttachmentsRequest(
            global::System.Net.Http.HttpClient httpClient,
        ...
        partial void ProcessEmailsListReceivingAttachmentsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessEmailsListReceivingAttachmentsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Resend.ListAttachmentsResponse> EmailsListReceivingAttachmentsAsync(
            global::System.Guid emailId,
            int? limit = default,
        ...
        {
            var __response = await EmailsListReceivingAttachmentsAsResponseAsync(
                emailId: emailId,
                limit: limit,
                after: after,
                before: before,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Resend.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Resend.AutoSDKHttpResponse<global::Resend.ListAttachmentsResponse>> EmailsListReceivingAttachmentsAsResponseAsync(
            global::System.Guid emailId,
            int? limit = default,
            global::System.Guid? after = default,
            global::System.Guid? before = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareEmailsListReceivingAttachmentsArguments(
            ...
            var __authorizations = global::Resend.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_EmailsListReceivingAttachmentsSecurityRequirements,
                operationName: "EmailsListReceivingAttachmentsAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareEmailsListReceivingAttachmentsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Resend.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Resend.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "EmailsListReceivingAttachments",
                                methodName: "EmailsListReceivingAttachmentsAsync",
                                pathTemplate: "$\"/emails/receiving/{emailId}/attachments\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessEmailsListReceivingAttachmentsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Resend.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessEmailsListReceivingAttachmentsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Resend.ListAttachmentsResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Resend.AutoSDKHttpResponse<global::Resend.ListAttachmentsResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Resend.ListAttachmentsResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
