...
namespace Resend
{
    public partial class EmailsClient
    {
        ...
        private static readonly global::Resend.EndPointSecurityRequirement s_EditEmailsByEmailIdSecurityRequirement0 =
        ...
        private static readonly global::Resend.EndPointSecurityRequirement[] s_EditEmailsByEmailIdSecurityRequirements =
            new global::Resend.EndPointSecurityRequirement[]
            {                s_EditEmailsByEmailIdSecurityRequirement0,
            };
        partial void PrepareEditEmailsByEmailIdArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string emailId);
        partial void PrepareEditEmailsByEmailIdRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string emailId);
        partial void ProcessEditEmailsByEmailIdResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessEditEmailsByEmailIdResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Resend.UpdateEmailOptions> EditEmailsByEmailIdAsync(
            string emailId,
            global::Resend.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await EditEmailsByEmailIdAsResponseAsync(
                emailId: emailId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Resend.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Resend.AutoSDKHttpResponse<global::Resend.UpdateEmailOptions>> EditEmailsByEmailIdAsResponseAsync(
            string emailId,
            global::Resend.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareEditEmailsByEmailIdArguments(
            ...
            var __authorizations = global::Resend.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_EditEmailsByEmailIdSecurityRequirements,
                operationName: "EditEmailsByEmailIdAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareEditEmailsByEmailIdRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Resend.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Resend.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "editEmailsByEmailId",
                                methodName: "EditEmailsByEmailIdAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessEditEmailsByEmailIdResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Resend.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessEditEmailsByEmailIdResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Resend.UpdateEmailOptions.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Resend.AutoSDKHttpResponse<global::Resend.UpdateEmailOptions>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Resend.UpdateEmailOptions.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
