...
namespace Resend
{
    public partial class OAuthClient
    {
        ...
        private static readonly global::Resend.EndPointSecurityRequirement s_OauthRevokeGrantSecurityRequirement0 =
        ...
        private static readonly global::Resend.EndPointSecurityRequirement[] s_OauthRevokeGrantSecurityRequirements =
            new global::Resend.EndPointSecurityRequirement[]
            {                s_OauthRevokeGrantSecurityRequirement0,
            };
        partial void PrepareOauthRevokeGrantArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string oauthGrantId);
        partial void PrepareOauthRevokeGrantRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string oauthGrantId);
        partial void ProcessOauthRevokeGrantResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessOauthRevokeGrantResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Resend.RevokeOAuthGrantResponse> OauthRevokeGrantAsync(
            string oauthGrantId,
            global::Resend.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await OauthRevokeGrantAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Resend.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Resend.AutoSDKHttpResponse<global::Resend.RevokeOAuthGrantResponse>> OauthRevokeGrantAsResponseAsync(
            string oauthGrantId,
            global::Resend.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareOauthRevokeGrantArguments(
            ...
            var __authorizations = global::Resend.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_OauthRevokeGrantSecurityRequirements,
                operationName: "OauthRevokeGrantAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareOauthRevokeGrantRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Resend.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Resend.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "OauthRevokeGrantAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessOauthRevokeGrantResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Resend.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessOauthRevokeGrantResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
