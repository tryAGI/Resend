...
namespace Resend
{
    public partial class ContactsClient
    {
        ...
        private static readonly global::Resend.EndPointSecurityRequirement s_ContactsUpdateTopicsSecurityRequirement0 =
        ...
        private static readonly global::Resend.EndPointSecurityRequirement[] s_ContactsUpdateTopicsSecurityRequirements =
            new global::Resend.EndPointSecurityRequirement[]
            {                s_ContactsUpdateTopicsSecurityRequirement0,
            };
        partial void PrepareContactsUpdateTopicsArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string contactId,
            global::Resend.UpdateContactTopicsOptions request);
        partial void PrepareContactsUpdateTopicsRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string contactId,
            global::Resend.UpdateContactTopicsOptions request);
        partial void ProcessContactsUpdateTopicsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessContactsUpdateTopicsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Resend.UpdateContactTopicsResponseSuccess> ContactsUpdateTopicsAsync(
            string contactId,
        ...
        {
            var __response = await ContactsUpdateTopicsAsResponseAsync(
                contactId: contactId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Resend.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Resend.AutoSDKHttpResponse<global::Resend.UpdateContactTopicsResponseSuccess>> ContactsUpdateTopicsAsResponseAsync(
            string contactId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareContactsUpdateTopicsArguments(
            ...
            var __authorizations = global::Resend.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ContactsUpdateTopicsSecurityRequirements,
                operationName: "ContactsUpdateTopicsAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareContactsUpdateTopicsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Resend.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Resend.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ContactsUpdateTopics",
                                methodName: "ContactsUpdateTopicsAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessContactsUpdateTopicsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Resend.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessContactsUpdateTopicsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Resend.UpdateContactTopicsResponseSuccess.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Resend.AutoSDKHttpResponse<global::Resend.UpdateContactTopicsResponseSuccess>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Resend.UpdateContactTopicsResponseSuccess.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await ContactsUpdateTopicsAsync(
                contactId: contactId,
                request: __request,
                requestOptions: requestOptions,
